  ...
  <footer>
    <div class="justify-center items-center" id="contact">
      ...
      >
        ...
        <ul class="flex gap-[15px] text-white cursor-pointer">
          <a
            class="flex ease-in duration-200 hover:text-gray-400"
            href="tel:093-054-4488"
          >
            <svg
          ...
          >
            ...
            <p class="pl-2 hidden lg:block">Thatphum.pk@gmail.com</p>
          </a>
          <a
            class="flex ease-in duration-200 hover:text-gray-400"
            href="https://github.com/Thatphum"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            class="flex ease-in duration-200 hover:text-gray-400"
            href="https://www.linkedin.com/in/thatphum-pk/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        class="flex flex-col md:flex-row justify-center pt-2 sm:pt-2 pb-2 sm:pb-2 border-t text-center break-word"
      >
        <p>© 2022 Thatphum Kongnithichalerm.&nbsp</p>
